...
def create_checkout_session(request):
    ...
    session = stripe.checkout.Session.create(
        ...
        mode='payment',
        success_url='http://' + HttpRequest.get_host(request) + '/payment-success?session_id={CHECKOUT_SESSION_ID}',
        cancel_url='http://' + HttpRequest.get_host(request) + '/payment-cancel',
    )
